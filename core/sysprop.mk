...
ifeq (,$(strip $(BUILD_FINGERPRINT)))
  ...
  # Force the fingerprint to support our legacy scheme where
  # TARGET_PRODUCT=TARGET_DEVICE='FP3'.
  BUILD_FINGERPRINT := $(PRODUCT_BRAND)/$(TARGET_DEVICE)/$(TARGET_DEVICE):$(PLATFORM_VERSION)/$(BUILD_ID)/$(BF_BUILD_NUMBER):$(TARGET_BUILD_VARIANT)/$(BUILD_VERSION_TAGS)
endif
# unset it for safety.
BF_BUILD_NUMBER :=
